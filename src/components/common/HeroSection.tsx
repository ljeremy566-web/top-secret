    ...
    return (
        <section className="relative w-full h-[500px] flex flex-col items-center justify-center text-center px-4 mt-20">
            ...
            <div className="relative z-20 flex flex-col items-center gap-10">
                ...
                <button className="bg-[#FF9F1C] hover:bg-[#e88e15] text-black italic text-xl font-black px-12 py-4 uppercase flex items-center justify-center gap-2.5 shadow-[0_0_20px_rgba(255,159,28,0.3)] transition-all cursor-pointer tracking-wider transition-transform duration-300 hover:scale-110 ">
